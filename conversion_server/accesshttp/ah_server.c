...
#endif
//#ifdef CONVERSION
    ERR_RET_LN(add_handler("conversion.put_conversion",matchengine,CMD_CONVERSION_PUT_CONVERSION));
    ERR_RET_LN(add_handler("conversion.pending", matchengine, CMD_CONVERSION_QUERY));
//#endif
