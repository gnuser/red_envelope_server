...
static int init_methods_handler(void)
{
    ...
    ERR_RET_LN(add_handler("balance.withdraw", matchengine, CMD_PLEDGE_WITHDRAW));
    ERR_RET_LN(add_handler("balance.settle", matchengine, CMD_BALANCE_SETTLE));
    ERR_RET_LN(add_handler("balance.release", matchengine, CMD_BALANCE_RELEASE));
    ERR_RET_LN(add_handler("balance.exception", matchengine, CMD_BALANCE_EXCEPTION));
    ERR_RET_LN(add_handler("balance.reward", matchengine, CMD_BALANCE_REWARDS));
    ERR_RET_LN(add_handler("balance.airdrop", matchengine, CMD_BALANCE_AIRDROP));
    ERR_RET_LN(add_handler("balance.addnegactive", matchengine, CMD_BALANCE_ADDNEGACTIVE));
#endif
//#ifdef CONVERSION
    ERR_RET_LN(add_handler("order.put_order",matchengine,CMD_ORDER_PUT_ORDER));
    ERR_RET_LN(add_handler("order.put_match", matchengine, CMD_ORDER_PUT_MATCH));
//#endif
    ...
    ERR_RET_LN(add_handler("conversion.cancel", matchengine, CMD_ORDER_CANCEL));
    ...
    ERR_RET_LN(add_handler("conversion.deals", readhistory, CMD_ORDER_DEALS));
    ...
    ERR_RET_LN(add_handler("conversion.user_history", readhistory, CMD_USER_ORDER_HISTORY));
